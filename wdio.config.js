...
exports.config = {
    ...
    reporters: [
        ...
        'dot',
        ['json', {
            outputDir: './reports/json-reporter/',
            outputFileFormat: function (opts) {
                return `wdio-${opts.cid}.${new Date().getTime().toString(36)}.json`
            },
            stdout: false
        }],
        ['allure', {
            outputDir: './reports/allure-reporter/allure-results',
        }]
    ],
    ...
    onComplete: function (exitCode, config, capabilities, results) {
        ...
        mergeResults('./reports/json-reporter/', 'wdio-*', 'wdio-custom-filename.json');
    }
}
